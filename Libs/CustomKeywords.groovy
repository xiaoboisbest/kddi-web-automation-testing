...
def static "googlesheet.GoogleSheetKeywords.getSpreadSheetRecords"(
    	String spreadsheetId	
     , 	String range	) {
    (new googlesheet.GoogleSheetKeywords()).getSpreadSheetRecords(
        	spreadsheetId
         , 	range)
}

def static "googlesheet.GoogleSheetKeywords.setSpreadSheetRecords"(
    	String spreadsheetId	
     , 	String range	
     , 	String text	) {
    (new googlesheet.GoogleSheetKeywords()).setSpreadSheetRecords(
        	spreadsheetId
         , 	range
         , 	text)
}
