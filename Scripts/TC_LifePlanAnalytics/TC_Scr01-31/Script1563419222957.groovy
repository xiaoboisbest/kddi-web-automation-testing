...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q04_Future/NoPlanToMarry'))

not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q05_WhenGetMarry/Years_10'))

not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q06_NumberOfChildrenWanToGet/Children_3'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q07_YourIncome/income_UpTo300'))
...
not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q07_YourIncome/chk_NoRetirementPay'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q07_YourIncome/btn_Next'))

not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q08_IncomeOfTheSpouse/income_UpTo300'))

not_run: WebUI.scrollToElement(findTestObject('Tab_LifePlan/Page_Q08_IncomeOfTheSpouse/btn_Next'), 10)

not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q08_IncomeOfTheSpouse/chk_PartTimeIncome'))

not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q08_IncomeOfTheSpouse/chk_NoRetirementPay'))

not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q08_IncomeOfTheSpouse/btn_Next'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q09_RentHouse/rent_7'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q10_CostOfLiving/cost_10'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q11_CurrentSavingsAmount/amount_500'))
