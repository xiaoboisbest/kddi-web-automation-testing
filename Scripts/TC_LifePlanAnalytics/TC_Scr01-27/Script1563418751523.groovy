...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q04_Future/WantToMarryAndWantToHaveAChild'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q05_WhenGetMarry/Years_10'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q06_NumberOfChildrenWanToGet/Children_2'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q07_YourIncome/income_300'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q08_IncomeOfTheSpouse/income_1500'))
