...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q05_WhenGetMarry/Years_5'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q08_IncomeOfTheSpouse/income_700'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q10_CostOfLiving/cost_3'))
