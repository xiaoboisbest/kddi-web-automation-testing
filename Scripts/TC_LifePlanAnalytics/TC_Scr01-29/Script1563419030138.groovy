...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q01_Age/Age_50'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q4_FutureMarried/children_Yes'))

not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q05_WhenGetMarry/Years_10'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q06_NumberOfChildrenWanToGet/Children_3'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q10_CostOfLiving/cost_20'))
