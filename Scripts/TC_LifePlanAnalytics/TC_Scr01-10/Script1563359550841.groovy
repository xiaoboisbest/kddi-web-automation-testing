...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q05_WhenGetMarry/Years_1'))

not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q06_NumberOfChildrenWanToGet/Children_5'))
