...
not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q05_WhenGetMarry/Years_5'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q06_NumberOfChildrenWanToGet/Children_1'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q08_IncomeOfTheSpouse/income_900'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q10_CostOfLiving/cost_30'))
