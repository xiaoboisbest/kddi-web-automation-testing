...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q01_Age/Age_20'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q02_CurrentSituation/Single'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q03_Children/Children_2'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q04_Future/WantToGetMarried'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q05_WhenGetMarry/Years_3'))

not_run: WebUI.click(findTestObject('Tab_LifePlan/Page_Q06_NumberOfChildrenWanToGet/Children_1'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q08_IncomeOfTheSpouse/income_1000'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q09_RentHouse/rent_5'))
...
WebUI.click(findTestObject('Tab_LifePlan/Page_Q10_CostOfLiving/cost_5'))

WebUI.click(findTestObject('Tab_LifePlan/Page_Q11_CurrentSavingsAmount/amount_100'))
